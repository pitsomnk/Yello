  ...
  return (
    <View className="flex-1 justify-center items-center p-4">
      ...
      <Image
        ...
        resizeMode="cover" // Optional: cover, contain, etc.
      />
        <Text className="text-2xl font-bold text-gray-800 mb-2">
          Welcome Back
        </Text>
        <Text className="text-sm text-gray-500">
        Your journey to a better recyling experience.
        </Text>
      </View>
      ...
      <Pressable
        ...
        className="bg-yellow-500 w-full max-w-[300px] py-3 rounded-lg active:bg-blue-700"
      >
